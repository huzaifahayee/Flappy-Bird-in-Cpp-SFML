...
This project is built using **Visual Studio 2022** and **SFML 2.5.1**.
...
1. **Clone the Repo:**
   ...
   ```
2. **Requirements:**
   - [SFML 2.5.1](https://www.sfml-dev.org/download/sfml/2.5.1/) (VC++ 15 64-bit).
   - Visual Studio 2022.
3. **Configuration:**
